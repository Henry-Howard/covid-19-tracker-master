  ...
  return (
    ...
    >
      <form action="#" onSubmit={onSubmitFilter}>
        <h4 className="title is-4">TÌM KIẾM</h4>
        <label className="label">TÊN QUỐC GIA</label>
        <div className="field more-margin-bottom">
          <div className="control is-expanded">
            <input
              className="input"
              type="text"
              placeholder="Để trống để bỏ qua bộ lọc tên."
              value={name}
              onChange={(e) => setName(e.target.value)}
            />
          </div>
        </div>
        <label className="label">Các trường hợp đã xác nhận</label>
