...
function ListView(props) {
  ...
  function scrollToSelected(location) {
    ...
    const childArray = Array.from(
      listLocationsRef.current.childNodes[1].childNodes
    );
  ...
  let totalElements = (
    <>
      <h4 className="title is-4">TỔNG CỘNG</h4>
      {totalDataElements}
    </>
  );
  ...
  let locationElements = (
    <div className="list-view__locations-data">{locationItemElements}</div>
  );
    ...
    <div className={listviewClass}>
      ...
      <div className="list-view__content">
        <div className="list-view__brand">
          <h1 className="title is-5">THEO DÕI COVID-19</h1>
          <h3 className="subtitle is-7">^_^</h3>
        ...
        <div
          className="list-view__locations list-view__content-block"
          ref={listLocationsRef}
        >
          {loadingView}
          {filterElements}
          {locationElements}
